...
def run_with_fallback(preset: str, initial_batch: int, geometry: str, data_perc) -> bool:
    ...
    for b in batch_plan:
        try:
            print(f"\n[GPU0] Preset={preset} | Trying batch={b} | Geometry={geometry} | Data perc={data_perc}")
            train_main(preset, b, geometry, data_perc)
...
def main_gpu0() -> None:
    ...
    for preset in PRESETS_GPU0:
        ...
        run_with_fallback(preset[0], initial_batch=200, geometry=preset[1], data_perc=preset[2])
